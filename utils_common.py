...
def show3Dpose_animation(channels, image_directory, iterations, tag, bs_idx, use_joint12=False, use_amass=False, use_lafan=False, dest_vis_path=None):
...
def show3Dpose_animation_multiple(channels, image_directory, iterations, tag, bs_idx, use_joint12=False, use_amass=False, use_lafan=False, \
